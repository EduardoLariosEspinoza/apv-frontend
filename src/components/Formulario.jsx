...
function Formulario() {
  // Recomendacion de poner el nombre de los states del formulario igual que el nombre de los campos en la API (Modelo de la BD)
  ...
  // Necesario para editar un paciente
  const [id, setId] = useState(null);

  const [alerta, setAlerta] = useState({});

  // Se llama a la funcion usePacientes ya que esta retorna los valores del context PacientesContext
